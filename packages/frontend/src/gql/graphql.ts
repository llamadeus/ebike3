...
export type CustomerViewQuery = { __typename?: 'Query', creditBalance: number, auth?: { __typename?: 'User', id: string, role: UserRole, username: string, lastLogin?: string | null } | null, position: { __typename?: 'Vec2d', x: number, y: number }, activeRental?: { __typename?: 'Rental', id: string, start: string, end?: string | null, cost?: number | null } | null, pastRentals: Array<{ __typename?: 'Rental', id: string, start: string, end?: string | null, cost?: number | null }>, availableVehicles: Array<{ __typename?: 'Vehicle', id: string, type: VehicleType, battery: number, position: { __typename?: 'Vec2d', x: number, y: number } }>, transactions: Array<{ __typename: 'Expense', id: string, amount: number, rentalId: string, createdAt: string } | { __typename: 'Payment', id: string, amount: number, status: PaymentStatus, createdAt: string }> };
