...
export type AdminViewQuery = { __typename?: 'Query', auth?: { __typename?: 'User', id: string, role: UserRole, username: string, lastLogin?: string | null } | null, users: Array<{ __typename?: 'User', id: string, role: UserRole, username: string, lastLogin?: string | null }>, stations: Array<{ __typename?: 'Station', id: string, name: string, createdAt: string, position: { __typename?: 'Vec2d', x: number, y: number } }>, vehicles: Array<{ __typename?: 'Vehicle', id: string, battery: number, createdAt: string, position: { __typename?: 'Vec2d', x: number, y: number }, activeRental?: { __typename?: 'VehicleRental', id: string, customerId: string, start: string, cost: number } | null }>, payments: Array<{ __typename?: 'Payment', id: string, amount: number, status: PaymentStatus, createdAt: string, customer?: { __typename?: 'Customer', id: string, name: string } | null }>, customers: Array<{ __typename?: 'Customer', id: string, name: string, creditBalance: number, lastLogin?: string | null, position: { __typename?: 'Vec2d', x: number, y: number }, activeRental?: { __typename?: 'CustomerRental', id: string, start: string, vehicleId: string, vehicleType: VehicleType } | null }> };

export type CustomerViewQueryVariables = Exact<{ [key: string]: never; }>;


export type CustomerViewQuery = { __typename?: 'Query', creditBalance: number, auth?: { __typename?: 'User', id: string, role: UserRole, username: string, lastLogin?: string | null } | null, activeRental?: { __typename?: 'Rental', id: string, start: string, end?: string | null, cost?: number | null } | null, pastRentals: Array<{ __typename?: 'Rental', id: string, start: string, end?: string | null, cost?: number | null }>, stations: Array<{ __typename?: 'Station', id: string, name: string, createdAt: string, position: { __typename?: 'Vec2d', x: number, y: number } }>, availableVehicles: Array<{ __typename?: 'Vehicle', id: string, type: VehicleType, battery: number, position: { __typename?: 'Vec2d', x: number, y: number } }>, transactions: Array<{ __typename: 'Expense', id: string, amount: number, rentalId: string, createdAt: string } | { __typename: 'Payment', id: string, amount: number, status: PaymentStatus, createdAt: string }> };
